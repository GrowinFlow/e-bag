            ...
            <div className="flex gap-4">
                ...
                <div className="w-full">
                    <div className="md:pl-4 flex justify-between items-center">
                        ...
                        <button name='listView' type="button" className={grid_view ? "p-2 font-medium focus:outline-none rounded-md border border-gray-200 bg-gray-100 text-teal-700 focus:z-10 ring-1 ring-teal-700" : "p-2 font-medium text-gray-900 focus:outline-none bg-white rounded-md border border-gray-200 hover:bg-gray-100 hover:text-teal-700 focus:z-10"} onClick={setGridView}>
                            ...
                            <button name='listView' type="button" className={grid_view ? "p-2 font-medium text-gray-900 focus:outline-none bg-white rounded-md border border-gray-200 hover:bg-gray-100 hover:text-teal-700 focus:z-10" : "p-2 font-medium focus:outline-none rounded-md border border-gray-200 bg-gray-100 text-teal-700 focus:z-10 ring-1 ring-teal-700"} onClick={setListView}>

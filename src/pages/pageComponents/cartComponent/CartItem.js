...
const CartItem = ({id, quantity, image, catlog, name, price}) => {
  ...
  return (
    <>
    <div className='grid grid-cols-3 md:grid-cols-5 p-2 border-2 border-dotted border-gray-300 rounded-xl'>
...
<i className='fa-solid fa-trash text-red-600  active:text-teal-700 hover:scale-125  transition-all duration-300 ease-in cursor-pointer'></i>
</div>
    </div>
    </>
  )

                ...
                <ul className={`transition-all duration-300 ease-in-out pb-4 md:py-0  absolute md:relative bg-gray-100 w-full mx-auto right-[1px] top-12  md:top-0  flex-col md:flex-row md:items-center justify-center px-4 md:px-8 md:justify-end gap-4 md:gap-2 order-3 md:order-2 col-span-2 md:col-span-7  ${show ? 'block' : 'hidden'} md:flex`}>
                   ...
                   <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M160-720v-80h640v80H160Zm0 560v-240h-40v-80l40-200h640l40 200v80h-40v240h-80v-240H560v240H160Zm80-80h240v-160H240v160Zm-38-240h556-556Zm0 0h556l-24-120H226l-24 120Z"/></svg>
                    ...
                    <div className='flex items-center gap-4 md:gap-0'>
                        ...
                        <span className='rounded-full bg-teal-700 text-white min-w-[18px] max-w-[20px] h-[18px] flex items-center justify-center relative md:-top-2 text-[10px]'>{total_item }</span>
                        </div>} />

                    <NavItem toLink="/contact" linkName={
                        <>

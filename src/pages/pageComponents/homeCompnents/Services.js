    ...
    return (
        <>
            ...
            <section className="bg-whit">
                <div className="grid py-8 container mx-auto grid-cols-auto md:grid-cols-3 gap-3 md:gap-8 md:flex-row flex-col">

                    <div className="rounded-md md:rounded-lg bg-slate-100 shadow-lg border-2 border-gray-200 h-58 flex flex-col justify-center items-center">
                    ...
                    <div className="grid grid-rows-2 gap-3 md:gap-8">

                        <div className="rounded-md md:rounded-lg bg-slate-100 shadow-lg border-2 border-gray-200 h-28 flex flex-col justify-center items-center">
